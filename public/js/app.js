...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var coffee = JSON.parse(btn.dataset.coffee);
    updateCart(coffee);
  });
...
function updateStatus(order) {
  ...
  statuses.forEach(function (status) {
    ...
    if (dataProp == order.status) {
      stepCompleted = false;
      time.innerText = dayjs__WEBPACK_IMPORTED_MODULE_3___default()(order.updateAt).format('MMM D, YYYY h:mm A');
...
socket.on('orderUpdated', function (data) {
  ...
  updatedOrder.updateAt = dayjs__WEBPACK_IMPORTED_MODULE_3___default()().format();
...
__webpack_require__(/*! D:\work\Realtime-Coffee-Tracker\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! D:\work\Realtime-Coffee-Tracker\resources\scss\app.scss */"./resources/scss/app.scss");
